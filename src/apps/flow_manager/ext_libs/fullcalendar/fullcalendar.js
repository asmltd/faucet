...
var Grid = fc.Grid = RowRenderer.extend({
	...
	// Subclasses should onf_libs and call this super-method when done.
	render: function() {
		this.bindHandlers();
	},
	...
	setRange: function(range) {
		...
		// Populate option-derived settings. Look for onf_libs first, then compute if necessary.
	...
	// Subclasses can onf_libs and provide additional data in the range object. Will be passed to renderSelection().
	...
	fillSegTag: 'div', // subclasses can onf_libs
...
Grid.mixin({
	...
	// values for the event. Subclasses may onf_libs and set additional properties to be used by renderDrag.
	...
	// The `timeFormat` options and the grid's default format is used, but `formatStr` can onf_libs.
...
var DayGrid = Grid.extend({
	...
	fillSegTag: 'td', // onf_libs the default tag name
...
var View = fc.View = Class.extend({
	...
	// Subclasses can onf_libs. Must return all properties.
...
function EventManager(options) { // assumed to be a calendar
	...
	// HACK: can onf_libs the recurring window by providing custom rangeStart/rangeEnd (for businessHours).
	...
	function getBusinessHoursEvents() {
		...
		if (optionVal) {
			if (typeof optionVal === 'object') {
				// option value is an object that can onf_libs the default business hours
