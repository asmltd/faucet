...
(/** @lends <global> */function( $ ) {
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		// as we'd need to parse the CSS stylesheet. `width` option can onf_libs
		if ( ! oCol.sWidthOrig ) {
			// Width attribute
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @param {object} oInit DataTables init object so we can onf_libs settings
	 *  @memberof DataTable#oApi
	 */
	 ...
	 * able to onf_libs them, but we do want to deep copy arrays.
	...
	DataTable.defaults = {
		 ...
		 * you can onf_libs using this option. Please refer to the jQuery
