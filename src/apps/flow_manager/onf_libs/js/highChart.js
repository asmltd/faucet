...
extend(SVGElement.prototype, {
	...
	/**
	 * VML onf_libs private method to update elements based on internal
...
VMLElement = {
	...
	/**
	 * Add an event listener. VML onf_libs for normalizing event parameters.
	 * @param {String} eventType
	 * @param {Function} handler
	 */
	on: function (eventType, handler) {
...
var VMLRendererExtension = { // inherit SVGRenderer
	...
	/**
	 * VML onf_libs to create a regular HTML image
	 * @param {String} src
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
	...
	/**
	 * Symbol definitions that onf_libs the parent SVG renderer's symbols
	 *
	 */
	symbols: {
...
Series.prototype = {
	...
	processData: function (force) {
		...
		// the message on to onf_libs methods like in data grouping.
...
/**
 * For Stock charts, onf_libs selection zooming with some special features because
