...
var locationPrototype = {
   ...
   * will onf_libs only a single search property.
   *
   * If `paramValue` is an array, it will onf_libs the property of the `search` component of
...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     *                              append/onf_libs services provided by `providers`. This is handy
     *                              when unit-testing and having the need to onf_libs a default
     *                              service.
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   *
   * You can onf_libs this for input directives whose concept of being empty is different to the
